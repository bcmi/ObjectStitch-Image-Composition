...
We also provide the results of 640 pairs of foregrounds and backgrounds from [FOSCom](https://github.com/bcmi/ControlCom-Image-Composition?tab=readme-ov-file#FOSCom-Dataset) dataset, which can be downloaded from [Baidu Cloud](https://pan.baidu.com/s/1x-GQ0qzLFT2HOBvNDpcwsA?pwd=9g1p) (9g1p). Based on the results, you can quickly know the ability and limitation of ObjectStitch. 
