...
ObjectStitch is very robust and the generated images are of high quality. Especially for foreground pose variation, this method can usually produce reasonable foreground poses. However, the foreground details could be lost or altered for those complex or rare objects. **If you use this method for specific objects, we recommend finetuning this model based on the images of specific objects, because the finetuned model can better preserve the foreground details.** 
